...
// for (const post of userPostsArr) {
...
//     emptyArr[j] = Math.round(Math.random()*50);
// }

// d. Заповнити масив 20ма рандомними чисалами в діапазоні від 8 до 732 (Google: Generate random number JS)
for (let i = 0, j = 0; i < 20; i++, j++) {
    emptyArr[j] = Math.round(Math.random() * (732 - 8) + 8);
}
console.log(emptyArr);
...
const numbArr = [];
for (let i = 0, k = 0; i < emptyArr.length; i += 3) {
...
const numbers = [1, 2, 3, 5, 7, 9, 56, 8, 67];
...
let result = sum / purchases.length
console.log(result);
//
// 7. Створити масив з рандомними значеннями, помножити всі його елементи на 5 та перемістити їх в інший масив.
const randomNumbArr = [5, 15, 25, 35, 225, 100];
const numbFixArr = [];
for (let i = 0, j = 0; i < randomNumbArr.length; i++, j++) {
    numbFixArr[j] = randomNumbArr[i] * 5;
}
console.log(numbFixArr);
// 8. Створити масив з будь якими значеннями (стрінги, числа, і тд...). пройтись по ньому, і якщо елемент є числом - додати його в інший масив.
const mixArr = ['hello', 26, true, 36, false, 'hand', 1000];
const filterNumbArr = [];
for (let i = 0, k = 0; i < mixArr.length; i++) {
    if (typeof mixArr[i] === "number") {
        filterNumbArr[k] = mixArr[i];
        k++
    }
}
console.log(filterNumbArr);
